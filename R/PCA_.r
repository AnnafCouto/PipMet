...
#' }
#'}
PCA_ <- function(n, metadata, myDir, colors, pic_extension = c('.tiff', '.png')) {
  ...
  subgroup <- dlg_list(as.character(unique(metadata[, group])), multiple = FALSE, title = "Choose a particular condition to plot PCA:")$res
