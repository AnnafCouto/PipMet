...
#' PCA_identified(n, metadata, myDir = '~/', colors)
#' }
#'}
PCA_identified <- function(n, metadata, myDir, colors, pic_extension = c(".tiff",
    ".png"), example = FALSE) {
    ...
    for (i in seq_len(length(colors))) {
        ...
        if (".png" %in% pic_extension) {
            png(paste0("PCA_", names(colors)[[i]], ".png"), units = "cm", width = 16,
                height = 16, res = 900, bg = "NA")
            print(ggplot(data = as.data.frame.array(pc$x), aes(x = pc$x[, 1],
                y = pc$x[, 2], color = colors[[i]][[1]])) + geom_point(size = 3,
                shape = 20) + theme_minimal() + labs(title = "PCA", x = paste0("PC1: ",
                ...
                plot.title = element_text(hjust = 0.5, color = "black", size = 16,
                  face = "bold")))
            dev.off()
            png(paste0("PCA_named_", names(colors)[[i]], ".png"), units = "cm",
            ...
            print(ggplot(data = as.data.frame.array(pc$x), aes(x = pc$x[, 1],
                ...
                x = paste0("PC1: ", format(pcSummary$importance[2, 1] * 100,
                  digits = 3), " % variance"), y = paste0("PC2: ", format(pcSummary$importance[2,
        ...
        if (".tiff" %in% pic_extension) {
            tiff(paste0("PCA_", names(colors)[[i]], ".tiff"), units = "cm", width = 16,
                height = 16, res = 900, bg = "NA")
            print(ggplot(data = as.data.frame.array(pc$x), aes(x = pc$x[, 1],
                y = pc$x[, 2], color = colors[[i]][[1]])) + geom_point(size = 3,
                shape = 20) + theme_minimal() + labs(title = "PCA", x = paste0("PC1: ",
                ...
                plot.title = element_text(hjust = 0.5, color = "black", size = 16,
                  face = "bold")))
            dev.off()
            tiff(paste0("PCA_named_", names(colors)[[i]], ".tiff"), units = "cm",
                width = 16, height = 16, res = 900, bg = "NA")
            print(ggplot(data = as.data.frame.array(pc$x), aes(x = pc$x[, 1],
                y = pc$x[, 2], label = metadata$sample, color = colors[[i]][[1]])) +
                geom_point(size = 3, shape = 20) + theme_minimal() + labs(title = "PCA",
    ...
    if (!example == TRUE) {
        ...
        subgroup <- dlg_list(as.character(unique(metadata[, group])), multiple = TRUE,
            title = "Condition to plot PCA:")$res
    } else {
        group <- "group"
    ...
    for (i in seq_len(length(colors))) {
        # png
        if (".png" %in% pic_extension) {
            png(paste0("PCAselected_", names(colors)[[i]], ".png"), units = "cm",
                width = 16, height = 16, res = 900, bg = "NA")
            print(ggplot(data = as.data.frame.array(pc$x), aes(x = pc$x[, 1],
                ...
                plot.title = element_text(hjust = 0.5, color = "black", size = 16,
                  face = "bold")))
            dev.off()
            png(paste0("PCAselected_named_", names(colors)[[i]], ".png"), units = "cm",
                width = 16, height = 16, res = 900, bg = "NA")
            print(ggplot(data = as.data.frame.array(pc$x), aes(x = pc$x[, 1],
        ...
        # tiff
        if (".tiff" %in% pic_extension) {
            tiff(paste0("PCAselected_", names(colors)[[i]], ".tiff"), units = "cm",
                width = 16, height = 16, res = 900, bg = "NA")
            print(ggplot(data = as.data.frame.array(pc$x), aes(x = pc$x[, 1],
                y = pc$x[, 2], color = colors[[i]][[1]][z])) + geom_point(size = 3,
                shape = 20) + theme_minimal() + labs(title = "PCA", x = paste0("PC1: ",
                ...
                plot.title = element_text(hjust = 0.5, color = "black", size = 16,
                  face = "bold")))
            dev.off()
            tiff(paste0("PCAselected_named_", names(colors)[[i]], ".tiff"), units = "cm",
                width = 16, height = 16, res = 900, bg = "NA")
            print(ggplot(data = as.data.frame.array(pc$x), aes(x = pc$x[, 1],
                y = pc$x[, 2], label = metadata$sample[z], color = colors[[i]][[1]][z])) +
                geom_point(size = 3, shape = 20) + theme_minimal() + labs(title = "PCA",
