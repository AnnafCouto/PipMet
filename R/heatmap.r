...
heatmap <- function(n, metadata, myDir, colors, pic_extension = c(".tiff", ".png"),
    replicate = NULL, sample_names = NULL) {
    ...
    for (i in seq_len(length(colors))) {
        ...
        if (".png" %in% pic_extension) {
            png(paste0(names(colors)[i], "_heatmap_scaled_geral.png"), units = "cm",
                width = 16, height = 16, res = 900, bg = "NA")
            pheatmap(mat_scaled, cluster_rows = FALSE, annotation = ann, annotation_colors = ant,
        ...
        if (".tiff" %in% pic_extension) {
            tiff(paste0(names(colors)[i], "_heatmap_scaled_geral.tiff"), units = "cm",
                width = 16, height = 16, res = 900, bg = "NA")
            pheatmap(mat_scaled, cluster_rows = FALSE, annotation = ann, annotation_colors = ant,
                main = "Heatmap of samples by spectra\n", fontsize_col = 5, fontsize_row = 4,
                show_rownames = FALSE, border_color = "NA")
    ...
    for (i in seq_len(length(colors))) {
        if (".png" %in% pic_extension) {
            png(paste0("named_", sample_names, "grouped_", names(colors)[i],
                "_heatmap_scaled_geral.png"), units = "cm", width = 16, height = 16,
                res = 900, bg = "NA")
        ...
        if (".tiff" %in% pic_extension) {
            tiff(paste0("named_", sample_names, "grouped_", names(colors)[i],
                "_heatmap_scaled_geral.tiff"), units = "cm", width = 16, height = 16,
                res = 900, bg = "NA")
            pheatmap(mat_scaled, cluster_rows = FALSE, main = "Heatmap of samples by spectra\n",
                fontsize_col = 5, fontsize_row = 4, show_rownames = FALSE, border_color = "NA")
            dev.off()
    ...
    for (i in seq_len(length(colors))) {
        ...
        if (".png" %in% pic_extension) {
            png(paste0("heatmap_scaled_ident_", names(colors)[i], "_.png"), units = "cm",
                width = 16, height = 16, res = 900, bg = "NA")
    ...
    for (i in seq_len(length(colors))) {
        if (".png" %in% pic_extension) {
            png(paste0("named_", sample_names, "heatmap_scaled_ident_", names(colors)[i],
                "_.png"), units = "cm", width = 16, height = 16, res = 900, bg = "NA")
            pheatmap(mat_ident_scaled, cluster_rows = FALSE, main = "Heatmap of samples by spectra\n",
                fontsize_col = 5, border_color = "NA", fontsize_row = 4)
            dev.off()
        }
        if (".tiff" %in% pic_extension) {
            tiff(paste0("named_", sample_names, "heatmap_scaled_ident_", names(colors)[i],
                "_.tiff"), units = "cm", width = 16, height = 16, res = 900,
                bg = "NA")
            pheatmap(mat_ident_scaled, cluster_rows = FALSE, main = "Heatmap of samples by spectra\n",
                fontsize_col = 5, border_color = "NA", fontsize_row = 4)
            dev.off()
    ...
    if (is.null(replicate)) {
        replicate <- dlg_list(c(colnames(metadata), "No information"), multiple = FALSE,
            title = "Replicate data:")$res
    }
    if (replicate == TRUE | replicate %in% colnames(metadata)) {
        ...
        if (".png" %in% pic_extension) {
            png("heatmap_repMean_scaled_geral.png", units = "cm", width = 16,
        ...
        if (".tiff" %in% pic_extension) {
            tiff("heatmap_repMean_scaled_geral.tiff", units = "cm", width = 16,
                height = 16, res = 900, bg = "NA")
            pheatmap(nhmedia_scaled, cluster_rows = FALSE, main = "Heatmap of samples by spectra\n",
                fontsize_col = 5, border_color = "NA", fontsize_row = 4)
            dev.off()
        ...
        # plot heatmaps png
        if (".png" %in% pic_extension) {
            png("heatmap_repMean_scaled_ident_unique.png", units = "cm", width = 16,
                height = 16, res = 900, bg = "NA")
        ...
        # tiff
        if (".tiff" %in% pic_extension) {
            tiff("heatmap_repMean_scaled_ident_unique.tiff", units = "cm", width = 16,
                height = 16, res = 900, bg = "NA")
            pheatmap(nhmedia_scaled_ident, cluster_rows = FALSE, main = "Heatmap of samples by spectra\n",
                fontsize_row = 4, fontsize_col = 5, border_color = "NA")
            dev.off()
